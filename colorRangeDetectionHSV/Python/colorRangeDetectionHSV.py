...
# Reduce the size of video to maxX x maxY so pi can process faster
cap.set(3,maxX)
cap.set(4,maxY)
...
while(1):
    ...
    circles = cv2.HoughCircles(closing,cv2.HOUGH_GRADIENT,2,120,param1=120,param2=50,minRadius=20,maxRadius=40)
